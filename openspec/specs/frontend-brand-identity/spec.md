...
Define onde e como a marca do produto aparece no painel, para que a identidade
não seja redecidida tela a tela. Cobre os pontos de contato — barra lateral,
login, aba do navegador e ícone de aplicativo —, a exigência de um componente
único como fonte da marca, a regra de guarda que impede a peça de ser exibida
abaixo do tamanho em que ela deixa de construir forma, e o comportamento da
marca diante do esquema de cor e de leitores de tela.

Não cobre o desenho da marca em si, que vem do pacote de identidade versionado
em `docs/marca/`, nem os ícones de interface, que continuam sob
`frontend-app-shell`.

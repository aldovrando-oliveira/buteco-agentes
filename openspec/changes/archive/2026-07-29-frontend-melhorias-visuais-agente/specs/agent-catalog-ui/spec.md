...
agentes sem enviar nenhuma requisição.
...
(`isActive`), com um link para editar o agente e uma ação para ativá-lo ou
...
detalhe do agente sem enviar nenhuma requisição.
